...
public static final String DECIMALVALUE="5";
...
public static final String CATEGORY_CODE="MET";
public static final String STICKER_NAME="QALEGENDPRODUCT";
public static final String TOP_MARGIN="2";
public static final String LEFT_MARGIN="3";
public static final String WIDTH="3";
public static final String HEIGHT="3";
public static final String NO_OF_STICKERS="20";
public static final String STICKERS_IN_ROW="5";
public static final String DISTANCE_BTWN_ROWS="2";
public static final String DISTANCE_BTWN_COLMNS="3";
public static final String BUSINESS_NAME="QAlegend";
